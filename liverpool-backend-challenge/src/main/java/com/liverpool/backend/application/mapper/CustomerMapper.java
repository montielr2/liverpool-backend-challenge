...
public class CustomerMapper {
  private CustomerMapper() {}
    ...
    /**
     * Maps a CreateCustomerRequest DTO to the domain Customer model.
     *
     * @param request request containing customer data
  ...
  public static Customer toDomain(CreateCustomerRequest request) {
    ...
    /**
     * Maps a Customer domain model to CustomerResponse DTO.
     *
  ...
  private static List<CustomerResponse.OrderResponse> toOrderResponses(List<CustomerOrder> orders) {
    ...
    return orders.stream()
        .map(order -> new CustomerResponse.OrderResponse(order.getOrderRef()))
        .toList();
  }
}
