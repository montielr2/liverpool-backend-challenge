...
/**
 * REST controller that exposes order search endpoints.
 */
...
public class OrderSearchController {
  ...
  @Operation(
      summary = "Búsqueda de pedidos",
      description =
          "Permite buscar por campos como orderRef, orderStatus, storeName o displayName.")
  @GetMapping("/search")
